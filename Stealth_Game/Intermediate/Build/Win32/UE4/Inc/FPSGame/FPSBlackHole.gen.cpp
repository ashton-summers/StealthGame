...
// End Cross Module References
	...
	UFunction* Z_Construct_UFunction_AFPSBlackHole_OverlapInnerSphere()
	{
		...
		if (!ReturnFunction)
		{
			...
			static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
				...
				{ "ToolTip", "Called when component overlaps with inners phere" },
			};
#endif
	...
	UClass* Z_Construct_UClass_AFPSBlackHole()
	{
		...
		if (!OuterClass)
		{
			...
			static const FClassFunctionLinkInfo FuncInfo[] = {
				{ &Z_Construct_UFunction_AFPSBlackHole_OverlapInnerSphere, "OverlapInnerSphere" }, // 3927392289
			};
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_OuterSphereComp = { UE4CodeGen_Private::EPropertyClass::Object, "OuterSphereComp", RF_Public|RF_Transient|RF_MarkAsNative, 0x00200800000a0009, 1, nullptr, STRUCT_OFFSET(AFPSBlackHole, OuterSphereComp), Z_Construct_UClass_USphereComponent_NoRegister, METADATA_PARAMS(NewProp_OuterSphereComp_MetaData, ARRAY_COUNT(NewProp_OuterSphereComp_MetaData)) };
#if WITH_METADATA
			static const UE4CodeGen_Private::FMetaDataPairParam NewProp_InnerSphereComp_MetaData[] = {
				{ "Category", "Components" },
				{ "EditInline", "true" },
				{ "ModuleRelativePath", "Public/FPSBlackHole.h" },
				{ "ToolTip", "Inner sphere that destroys overlapping components *" },
			};
#endif
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_InnerSphereComp = { UE4CodeGen_Private::EPropertyClass::Object, "InnerSphereComp", RF_Public|RF_Transient|RF_MarkAsNative, 0x00200800000a0009, 1, nullptr, STRUCT_OFFSET(AFPSBlackHole, InnerSphereComp), Z_Construct_UClass_USphereComponent_NoRegister, METADATA_PARAMS(NewProp_InnerSphereComp_MetaData, ARRAY_COUNT(NewProp_InnerSphereComp_MetaData)) };
#if WITH_METADATA
			static const UE4CodeGen_Private::FMetaDataPairParam NewProp_MeshComp_MetaData[] = {
				{ "Category", "Components" },
				{ "EditInline", "true" },
				{ "ModuleRelativePath", "Public/FPSBlackHole.h" },
				{ "ToolTip", "Mesh for our object *" },
			};
#endif
			...
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_OuterSphereComp,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_InnerSphereComp,
	...
	IMPLEMENT_CLASS(AFPSBlackHole, 2332696200);
